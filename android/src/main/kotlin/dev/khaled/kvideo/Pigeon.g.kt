...
enum class IMAStatus(val raw: Int) {
  AD_BREAK_READY(0),
  ...
  TAPPED(20),
  THIRD_QUARTILE(21),
  CONTENT_PAUSE_REQUESTED(22),
  CONTENT_RESUME_REQUESTED(23),
  /** iOS Only */
  STREAM_LOADED(24),
  /** iOS Only */
  STREAM_STARTED(25),
...
interface PlayerControllerApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: PlayerControllerApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.kvideo.PlayerControllerApi.skipIMAAd$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              api.skipIMAAd()
